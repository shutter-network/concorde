 ...
 * the tables and the values that define them, and import no other component's schema.
 *
 ...
 * A configuration listing any of those `/schema` subpaths without this one generates a constraint
