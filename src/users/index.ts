 ...
 * their migrations from. The Messenger, the Nostr Channel and Password Auth all point a foreign key
 * at it, so a schema carrying any of them without this subpath generates a constraint onto a table
 * it never creates.
 *
