 ...
 * Implementation: a Mount Table is a declaration of directories, files and a user, and
 * the same one would serve a second Runtime unchanged (ADR-0026, ADR-0028).
 */
