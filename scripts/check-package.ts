...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      "  // does — the Signal Worker's for the second time, which is one registration and",
      "  // not two, and the exported descriptors are why that entry point need construct",
      "  // nothing (ADR-0032).",
