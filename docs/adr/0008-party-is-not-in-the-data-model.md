...
A Shared Agent belongs to several parties at once — that premise is the reason this framework exists. Nonetheless the data model contains no Party entity. The User Manager knows Users, and nothing above them ([ADR-0029](./0029-users-are-a-part-of-their-own.md); this ADR originally said the Messenger); the core knows no identity at all ([ADR-0020](./0020-producers-are-trusted-components-of-the-gateway.md)).
