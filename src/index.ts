...
// `./users` and `./http-messenger`: the subpath exports are organisation rather than
// optionality, so a deployment that constructs no Messenger still loads the module. What
// the root does **not** import is `./pi`, and that edge is the one worth keeping absent
